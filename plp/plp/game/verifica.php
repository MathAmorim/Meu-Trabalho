    ...
    <div class="col-12 result">
        <div class="col-12 ">
            ...
            <div class="col-12 bresult">
                ...
                <button class="col-3"><span class="mt">Refazer</span><br><i class="fas fa-reply"></i></button>
                <span class="col-2"></span>
                <button class="col-3"><span class="mt">Proximo</span><br><i class="fas fa-rocket"></i></button>
            </div>
        </div>
    </div>
<?php
    ...
    <div class="col-12 result">
        <div class="col-12 ">
            ...
            <div class="col-12 bresult">
                <span class="col-4"></span>
                <button class="col-4"><span class="mt">Tentar Novamente</span><br><i class="fas fa-reply"></i></button>
            </div>
        </div>
    </div>
<?php
